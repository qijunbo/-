...
<div class="footer">
	<div class="section group">
		...
		<div class="col_1_of_4 span_1_of_4">
			<h3>Contact Us</h3>
			<ul class="nav1">
				<li>Building 10#, Keyuan Rd. 477,Shanghai</li>
				<li>China</li>
				<li>Phone:(+86)137-0164-8882</li>
				<li>Email:<a href="junboqi@cn.ibm.com"> <span>junboqi@cn.ibm.com</span></a></li>
			</ul>
		</div>
		<div class="col_1_of_4 span_1_of_4">
			<h3>Follow Us</h3>
			<div class="social-icons">
				<ul>
					...
					<li class="contact"><a href="junboqi@foxmail.com"
						target="_blank"> </a></li>
				</ul>
			</div>
		</div>
